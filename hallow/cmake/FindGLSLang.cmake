...
if(WIN32)
  ...
  if(CMAKE_SIZEOF_VOID_P EQUAL 8)
    set(_GLSLang_Library_Path_ "$ENV{VULKAN_SDK}/Lib" "$ENV{VULKAN_SDK}/Bin")
  elseif(CMAKE_SIZEOF_VOID_P EQUAL 4)
    set(_GLSLang_Library_Path_ "$ENV{VULKAN_SDK}/Lib32" "$ENV{VULKAN_SDK}/Bin32")
  endif()
else()
  set(_GLSLang_Include_Path_ "$ENV{VULKAN_SDK}/include")
  set(_GLSLang_Library_Path_ "$ENV{VULKAN_SDK}/lib")
endif()
