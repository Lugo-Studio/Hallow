...
namespace Hallow {
  ...
  SimpleRenderSystem::SimpleRenderSystem(Time& time, HallowDevice& device, VkRenderPass render_pass, bool use_srgb_color_space)
    : m_time{time}, m_hallow_device{device}, m_use_srgb_color_space{use_srgb_color_space} {
