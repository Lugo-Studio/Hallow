...
// class member functions
    ...
    void HallowDevice::createSurface() { window.createWindowSurface(instance, &surface_); }
    ...
    std::vector<const char*> HallowDevice::getRequiredExtensions() {
    ...
    uint32_t HallowDevice::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
    ...
    void HallowDevice::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
